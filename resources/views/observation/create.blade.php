            ...
            <div class="form-group observed-at-hr {{ $errors->has('observed_at_hr') ? 'has-error' : '' }}">
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-btn">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span id="am-pm">{{ date('A') }}</span> <span class="caret"></span></button>
